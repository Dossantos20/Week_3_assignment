...
getwd()
setwd("C:/Users/rod_d/Desktop/McDaniel/ANA 505/Week 3")
...
SexCol <- RodrigoTitanic$Sex
SexCol

AgeCol <- RodrigoTitanic$Age
AgeCol
...
RodrigoTitanic2 <- data.frame(Age = AgeCol, Sex = SexCol)
...
filter(RodrigoTitanic, Freq > 25)
RodrigoTitanic3 <- data.frame(filter(RodrigoTitanic, Freq > 25))
...
ggplot(RodrigoTitanic, aes(Survived, Freq)) +
  geom_col()
